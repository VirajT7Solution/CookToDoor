        ...
        >
          ...
          {isDesktop && (
            ...
            >
              ...
              >
                Sign in to continue enjoying delicious home-cooked meals delivered to your doorstep. Access your account and manage your orders with ease.
              </p>
              <div
                style={{
                  display: 'flex',
              ...
              >
                {[
                  { icon: '🔐', text: 'Secure and safe login' },
                  { icon: '📦', text: 'Track your orders' },
                  { icon: '❤️', text: 'Save your favorites' },
                ].map((feature, index) => (
                  <div
                    key={index}
                    style={{
