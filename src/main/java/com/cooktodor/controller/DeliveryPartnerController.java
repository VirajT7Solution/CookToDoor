...
public class DeliveryPartnerController {
    ...
    public ResponseEntity<com.cooktodor.model.Image> uploadDeliveryPartnerProfileImage(@PathVariable Long id, @RequestPart("file") MultipartFile file) throws Exception {
