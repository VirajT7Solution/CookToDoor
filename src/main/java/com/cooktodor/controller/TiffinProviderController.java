...
import com.cooktodor.utils.ImageResponse;
...
public class TiffinProviderController {
    ...
    @PreAuthorize("hasAnyRole('ADMIN','PROVIDER')")
    public ResponseEntity<com.cooktodor.model.Image> uploadProviderProfileImage(@PathVariable Long id, @org.springframework.web.bind.annotation.RequestPart("file") org.springframework.web.multipart.MultipartFile file) throws Exception {
