...
public class PasswordResetService {
    ...
    private void sendOtpEmail(User user, String otp) {
        ...
        String subject = "CookToDoor - Password Reset OTP";
    ...
    private void sendPasswordResetConfirmationEmail(User user) {
        ...
        String subject = "CookToDoor - Password Reset Successful";
    ...
    private String buildOtpEmailBody(String username, String otp) {
        ...
        body.append("<p>You have requested to reset your password for your CookToDoor account.</p>");
        ...
        body.append("• CookToDoor will never ask for your OTP via phone or email<br>");
    ...
    private String buildPasswordResetConfirmationEmailBody(String username) {
        ...
        body.append("</div>");
        body.append("<p>Thank you for using CookToDoor!</p>");
        body.append("<p>- The CookToDoor Team</p>");
